    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <div class="row">
                    <label for="per_hour_pay" class=" col-md-2">Per Hour Pay</label>
                    <div class="col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "per_hour_pay",
                            "name" => "per_hour_pay",
                            "value" => $job_info->per_hour_pay ? to_decimal_format($job_info->per_hour_pay) : "",
                            "class" => "form-control",
            ...
            <div class="form-group">
                <div class="row">
                    <label for="per_hour_rate" class=" col-md-2">Per Hour Rate</label>
                    <div class="col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "per_hour_rate",
                            "name" => "per_hour_rate",
                            "value" => $job_info->per_hour_rate ? to_decimal_format($job_info->per_hour_rate) : "",
                            "class" => "form-control",
