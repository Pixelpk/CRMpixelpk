    ...
    <div class="container-fluid">
        ...
        <div class="form-widget">
            ...
            <div class="progress ml15 mr15">
                <div id="form-progress-bar" class="progress-bar bg-success progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 10%">
                </div>
            </div>
        </div>
        ...
        <div class="tab-content mt15">
            ...
            <div role="tabpanel" class="tab-pane" id="job-info-tab">
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="per_hour_pay" class=" col-md-3">Per Hour Pay</label>
                        <div class=" col-md-9">
                            <?php
                            echo form_input(array(
                                "id" => "per_hour_pay",
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="per_hour_rate" class=" col-md-3">Per Hour Rate</label>
                        <div class=" col-md-9">
                            <?php
                            echo form_input(array(
                                "id" => "per_hour_rate",
