...
class Team_members extends Security_Controller {
    ...
    function add_team_member() {
        ...
        if ($user_id) {
            ...
            $job_data = array(
                ...
                "per_hour_pay" => $this->request->getPost('per_hour_pay') ? $this->request->getPost('per_hour_pay') : 0,
                "per_hour_rate" => $this->request->getPost('per_hour_pay') ? $this->request->getPost('per_hour_pay') : 0,
    ...
    function save_job_info() {
        ...
        $job_data = array(
            ...
            "per_hour_rate" => unformat_currency($this->request->getPost('per_hour_rate')),
            "per_hour_pay" => unformat_currency($this->request->getPost('per_hour_pay')),
            "salary_term" => $this->request->getPost('salary_term'),
            "date_of_hire" => $this->request->getPost('date_of_hire')
        );
