...
class Attendance extends Security_Controller {
    ...
    private function _make_row($data) {
        ...
        $note_link = modal_anchor(get_uri("attendance/note_modal_form"), "<i data-feather='eye' class='icon-16 '></i>", array("class" => "edit text-muted", "title" => app_lang("note"), "data-post-id" => $data->id));
        if ($data->note) {
            $note_link = modal_anchor(get_uri("attendance/note_modal_form"), "<i data-feather='eye' class='icon-16'></i>", array("class" => "edit text-muted", "title" => $note_title, "data-modal-title" => app_lang("note"), "data-post-id" => $data->id));
        }
